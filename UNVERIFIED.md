...
| `@cristibundukamara` | Mentally STRONG by Dr. B, 412 uploads, <100k | **Deferred for the owner's rule 12 decision, not rejected** (`grief-and-loss`). A self-described psychiatric nurse practitioner who lost three children and her husband; strongly on brief — "Grief theories \| 5 stages and more" debunks the stage model and covers the dual process model, continuing bonds and prolonged grief disorder. Against it in a high-stakes category: 217 of 412 descriptions carry programme, academy or intensive wording, including a paid "Grief Intensive" offered to people who are grieving, and a few titles react to news stories of loss. The Grief Channel was taken as the clear pick. |
